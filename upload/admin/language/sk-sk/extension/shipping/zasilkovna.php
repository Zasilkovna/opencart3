...
// Text global
$_['text_success'] = 'Nastavenie modulu Packeta bolo úspešne uložené.';
...
$_['entry_weight_max'] = 'Max. hmotnosť (kg)';
...
$_['entry_ol_order_date_to'] = 'Koncový dátum objednávky';
...
$_['column_order_weight'] = 'Hmotnosť';
...
$_['column_carrier_name'] = 'Názov';
$_['column_carrier_country'] = 'Krajina';
$_['column_carrier_currency'] = 'Mena';
$_['column_carrier_max_weight'] = 'Max. hmotnosť (kg)';
...
$_['error_missing_param'] = 'Požiadavka je nesprávna. Chýba povinný parameter.';
...
$_['text_api_key_needed_part1'] = 'Pre správnu funkciu modulu je potrebné vyplniť platný API kľúč. Nájdete ho v klientskej sekcii Packety';
$_['text_api_key_needed_part2'] = 'tu';
$_['text_api_key_needed_part3'] = 'Bez vyplneného API kľúča nie je možné modul používať. Preto je modul teraz vypnutý.';

// Help
$_['help_status'] = 'Zapína a vypína modul Packeta.';
$_['help_api_key'] = 'Zadajte správny kľúč pre komunikáciu s Packeta API.';
...
// Upgrade
$_['extension_upgraded'] = 'Modul bol aktualizovaný na verziu %s';
$_['extension_upgrade_failed'] = 'Aktualizácia databázy na novú verziu sa nepodarila:';
$_['please_see_log'] = 'Skontrolujte prosím chybové záznamy OpenCartu v časti Systém – Údržba – Chybové hlásenia.';
$_['extension_may_not_work'] = 'Modul momentálne nemusí správne fungovať.';
$_['error_needs_to_be_resolved'] = 'Je potrebné chybu vyriešiť. Po jej vyriešení obnovte stránku, aktualizácia sa spustí znova.';

// Orders
$_['orders_updated'] = 'Objednávky boli aktualizované.';
